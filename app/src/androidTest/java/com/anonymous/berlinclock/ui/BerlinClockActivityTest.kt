...
class BerlinClockActivityTest {
    ...
    fun shouldDisplayMinutesLamps(){
        with(composeTestRule){
            ...
            val topMinutes5 = onNodeWithTag("topMinutesLamp5")
            val topMinutes6 = onNodeWithTag("topMinutesLamp6")
            val topMinutes7 = onNodeWithTag("topMinutesLamp7")
            val topMinutes8 = onNodeWithTag("topMinutesLamp8")
            val topMinutes9 = onNodeWithTag("topMinutesLamp9")
            val topMinutes10 = onNodeWithTag("topMinutesLamp10")
            val topMinutes11 = onNodeWithTag("topMinutesLamp11")
